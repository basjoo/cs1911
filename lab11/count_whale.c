...
// cs1911
// Lab 11 - count_whale.c

// INPUT
// whaleType is provided by command line argument
...
// DESCRIPTION
// Program which prints the number of whale pods and the total number of whales
// within those pods
